...
In addition, we introduce an **experimental firm size dimension** in the customs data to provide more transparency. Firms are classified based on their total export values according to the following **percentile thresholds**:
...
These criteria are preliminary and purely exploratory, intended to provide an additional dimension for linking the customs data with the R&D survey.

This mapping enables analyses such as:

-   Estimating **export intensity by industry and size** and comparing it with firms’ R&D investment patterns.\
...
This alignment allows for the creation of a **sector/size–year panel** combining:
